...
public class DontForgetTheLyrics {
	...
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null,
				"In this game, you will be guessing the name of the song by listening to part of it");
		// 5. Use the playSound method to play your song.
		playSound("song.wav");
		// 6. Make a pop-up for the player to type their answer.
		String x = JOptionPane.showInputDialog("What is the name of the song(answer in lower case)");
		// 7. If they answered correctly, tell them that they were right.
		if (x.equals("sunflower")) {
			JOptionPane.showMessageDialog(null, "CORRECT!");
		}
		// 8. Otherwise, tell them they are wrong, and give them the answer.
		else {
			JOptionPane.showMessageDialog(null, "Sorry, that's incorrect. The song name is sunflower");
		}
		...
		if (y.equals("thunder")) {
			...
			JOptionPane.showMessageDialog(null, "Sorry, that's incorrect. The song name is thunder");
		}
